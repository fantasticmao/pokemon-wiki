...
import cn.fantasticmao.pokemon.web.repoistory.AbilityDynamicRepository;
...
/**
 * AbilityDynamicRepositoryImpl
 *
 * @author fantasticmao
 * @since 2023-02-19
 */
public class AbilityDynamicRepositoryImpl implements AbilityDynamicRepository {
    @Resource
    private NamedParameterJdbcTemplate namedParameterJdbcTemplate;

    @Override
    public List<Ability> findByName(@Nullable String nameZh, @Nullable String nameEn) {
        ...
        return namedParameterJdbcTemplate.query(sql, paramMap,
            new BeanPropertyRowMapper<>(Ability.class));
    }
}
