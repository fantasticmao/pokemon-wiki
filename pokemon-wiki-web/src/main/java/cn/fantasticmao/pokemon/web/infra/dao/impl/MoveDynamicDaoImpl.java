...
import cn.fantasticmao.pokemon.web.infra.dao.MoveDynamicDao;
 ...
 * @since 2023-02-19
 */
public class MoveDynamicDaoImpl implements MoveDynamicDao {
    @Resource
    private NamedParameterJdbcTemplate namedParameterJdbcTemplate;

    @Override
    public List<MovePo> findByName(@Nullable String nameZh, @Nullable String nameEn) {
        ...
        return namedParameterJdbcTemplate.query(sql, paramMap,
            new BeanPropertyRowMapper<>(MovePo.class));
    }
}
