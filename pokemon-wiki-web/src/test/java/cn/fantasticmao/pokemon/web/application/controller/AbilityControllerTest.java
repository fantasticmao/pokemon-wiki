 ...
 *
 * @author fantasticmao
 * @see cn.fantasticmao.pokemon.web.application.controller.AbilityController
 * @since 2022/3/3
 */
    ...
    public void listAbilityDetail_ok() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/ability/detail?nameZh={nameZh}&nameEn={nameEn}", nameZh, nameEn))
            ...
            .andDo(result -> {
                ...
                List<AbilityResponse> list = JsonUtil.fromJson(bodyJson, new TypeReference<>() {
                });
                Assertions.assertEquals(1, list.size());

                AbilityResponse stench = list.getFirst();
