...
public class SpringTest {
    ...
    protected void assertStench(AbilityBean stench) {
    ...
    protected void assertRepel(ItemBean repel) {
    ...
    protected void assertPound(MoveBean pound) {
    ...
    protected void assertBulbasaur(PokemonBean bulbasaur) {
