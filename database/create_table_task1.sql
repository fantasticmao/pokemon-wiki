...
CREATE TABLE IF NOT EXISTS pw_pokemon (
  ...
  DEFAULT CHARSET 'utf8mb4' COMMENT '宝可梦列表（按全国图鉴编号）';
...
CREATE TABLE IF NOT EXISTS pw_pokemon_ability (
  ...
  DEFAULT CHARSET 'utf8mb4' COMMENT '宝可梦特性列表（按全国图鉴编号）';
...
CREATE TABLE IF NOT EXISTS pw_pokemon_base_stat (
  ...
  `index`    INT UNSIGNED      NOT NULL DEFAULT 0 COMMENT '全国图鉴编号',
  nameZh     VARCHAR(32)       NOT NULL DEFAULT '' COMMENT '中文名称',
  hp         TINYINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT 'HP',
  attack     TINYINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT '攻击',
  defense    TINYINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT '防御',
  spAttack   TINYINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT '特攻',
  spDefense  TINYINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT '特防',
  speed      TINYINT UNSIGNED  NOT NULL DEFAULT 0 COMMENT '速度',
  total      SMALLINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '总和',
  average    FLOAT UNSIGNED    NOT NULL DEFAULT 0 COMMENT '平均值',
  createTime DATETIME          NOT NULL DEFAULT current_timestamp COMMENT '创建时间',
  modifyTime DATETIME          NOT NULL DEFAULT current_timestamp ON UPDATE current_timestamp COMMENT '修改时间',
  PRIMARY KEY (id)
) ENGINE InnoDB
  DEFAULT CHARSET 'utf8mb4' COMMENT '宝可梦种族值列表（第七世代）';
...
CREATE TABLE IF NOT EXISTS pw_ability (
  ...
  DEFAULT CHARSET 'utf8mb4' COMMENT '特性列表';
...
CREATE TABLE IF NOT EXISTS pw_nature (
  ...
  DEFAULT CHARSET 'utf8mb4' COMMENT '性格列表';
...
CREATE TABLE IF NOT EXISTS pw_move (
  ...
  DEFAULT CHARSET 'utf8mb4' COMMENT '招式列表';
